...
function mv(){
	...
	$output .= "</ul></div></div><div class=\"main\"><a href=\"http://www.dibin.xyz\" target=\"_blank\"><img width=\"910\" src=\"http://www.dibin.xyz/m/m/1974892005.jpg\"></a></div>";
return $output;
}
//首页歌曲
function bang(){
...
function song_lrc($id){
	...
	$output = "<a href=\"http://www.dibin.xyz\" target=\"_blank\"><img src=\"http://ww3.sinaimg.cn/mw690/6b229b76jw1f8qfzhnmvrj20jg0jgdpf.jpg\" width=\"280px\" height=\"200px\"/></a>";
	}
return $output;
}
//大小转换//
...
.header .logo a{display:inline;float:left;width:143px;height:43px;background:url('http://www.dibin.xyz/m/m/123.jpg');background-repeat:no-repeat;background-size:143px 43px;}
...
<div class="header">
	<div class="h_main">
		...
		<ul class="member">
		<li><a class="seh_a seh_c" href="about.php" id="#">图片外链</a></li>
		</ul>
	</div>
</div>
<!-- toper End -->
...
<p><script language="javascript">var datatime=new Date(); document.write("&copy; 2018-"+datatime.getFullYear()+".");</script> 帝彬 <?php echo $lxfs;?> <a target="_blank" href="https://1974892005.github.io/">官网</a> 丨 <a target="_blank" href="https://1974892005.github.io/">帝彬云提供计算服务</a></p>
<p><a href="https://1974892005.github.io/" target="_blank"><img src="http://m.dibin.xyz/m/m/ic_launcher.png" title="帝彬云提供计算服务"/></a></p>

...
<head>
    ...
    <meta name="description" content="音乐搜索解决方案，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、5sing原创音乐、SoundCloud。">
    ...
    <link rel="canonical" href="https://1974892005.github.io/">
  ...
  <header class="am-topbar am-topbar-fixed-top">
        <div class="am-container">
            <h1 class="am-topbar-brand">
              <a href="https://1974892005.github.io/">帝彬实验室</a>
            </h1>
            ...
            <nav class="am-collapse am-topbar-collapse am-fr" id="collapse-head">
                <ul class="am-nav am-nav-pills am-topbar-nav">
                    <li>
                      <a href="https://1974892005.github.io/Task6">VIP视频解析</a>
                    </li>
                    <li class="am-active">
                      <a href="https://1974892005.github.io/music">音乐搜索器</a>
                    </li>
        <ul class="am-nav am-nav-pills am-topbar-nav">
                    <li>
                      <a href="/about.html">关于程序</a>
                    </li>        </ul>
            </nav>
        </div>
    </header>
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                ...
                <p class="am-text-center">帝彬多站合一音乐搜索解决方案</p>
            </header>
            <hr>
                ...
                <form class="am-form am-margin-bottom-lg" method="post" id="form-vld">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input id="music_input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如: 我的看出所 " data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
        ...
        <div class="am-popup" id="update-info">
            <div class="am-popup-inner">
                ...
                <div class="am-popup-bd">
                    <ul>
                        <li>2018.04.28 <code>v1.0</code> 音乐搜索器正式上线</li>
                        <li>2018.04.28 <code>v1.1</code> 更新正则匹配规则</li>
                        <li>2018.04.28 <code>v1.2.1</code> 修复正则表达式问题</li>
                       </ul>
                </div>
            </div>
        </div>
...
<p>Email:dibinKf@gmail.com<br>
QQ:1974892005</p>                </div>
            </div>
        </div>
    </section>
    <footer class="footer">
        <p class="am-text-sm">如果获取失败，请 <a href="http://wpa.qq.com/msgrd?v=3&uin=1974892005&site=qq&menu=yes" target="_blank" rel="author">@帝彬</a> © 2018-<?php echo date('Y', time()); ?> <a href="javascript:void(0)" data-am-modal="{target: '#update-info'}">更新日志</a> <a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">版权声明</a> <a href="https://1974892005.github.io/music" target="_blank">共享</a></p>
    </footer>
